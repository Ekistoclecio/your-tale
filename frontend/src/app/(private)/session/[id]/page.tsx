...
export default function GameSessionPage() {
  ...
  const { data: characters, isLoading: isCharactersLoading } = useSessionCharactersQuery(sessionId as string);
  ...
  if (!sessionData || isLoading || isCharactersLoading) return null;
